    ...
    function WriteInterpretationDialog(props) {
        ...
        _this.handleSubmit = function () {
            var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(event) {
                var _this$props, favoriteType, favoriteModel, onRequestWriteInterpretation, onRequestWriteInterpretationError, form, url, headers;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                _this$props = _this.props, favoriteType = _this$props.favoriteType, favoriteModel = _this$props.favoriteModel, onRequestWriteInterpretation = _this$props.onRequestWriteInterpretation, onRequestWriteInterpretationError = _this$props.onRequestWriteInterpretationError;
                                ...
                                form = _this.state;
                                url = '/interpretations/' + favoriteType + '/' + favoriteModel.id;
